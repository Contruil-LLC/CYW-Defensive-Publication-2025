...
# Origin Story: Amazon Experiments (2023)

## The Spark

September 2023. Waterspider shift at ORF3. I was moving bins between stations when the pattern hit me: **this is packet routing**. Every bin is a data packet. Every station is a node. Every Waterspider is a protocol handler ensuring delivery guarantees.
